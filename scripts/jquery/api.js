...
YG = {
	...
	// 带缓存
	api_knowledge: function (webpath, action, params, callback) {
		if (!params) {
			params = {};
		}
		if (!callback) {
	...
	api_debug: function (webpath, action, params, callback) {
		if (!params) {
			params = {};
		}
		if (!callback) {
